...
driver = webdriver.Chrome('/users/Osezno/Desktop/chromedriver')
...
for linkedin_url in linkedin_urls:
	...
	school = sel.xpath('//*[starts-with(@class, "pv-top-card-section__school")]').extract_first()

	if school:
		school = school.strip()

	location = sel.xpath('//*[starts-with(@class, "pv-top-card-section__location")]').extract_first()
